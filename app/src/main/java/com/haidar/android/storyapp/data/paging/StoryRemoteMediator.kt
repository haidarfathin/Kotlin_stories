...
import com.haidar.android.storyapp.data.paging.database.RemoteKeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        return try {
            val token = runBlocking { repository.getSession().first().token }
            val responseData = apiService.getPagingStories(
                "Bearer $token",
                page,
